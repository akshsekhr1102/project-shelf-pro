...
export function DashboardNavbar() {
  ...
  return (
    <>
      ...
      <nav className=" flex px-4 gap-x-4 items-center py-4 border-b bg-background justify-between">
        ...
        <div className="hidden md:block">
          {data?.user && (
            <div className=" min-w-[240px] justify-start font-normal  hover:text-muted-foreground ">
              Hey {data.user.name}, Welcome back!
            </div>
          )}
        </div>
      </nav>
